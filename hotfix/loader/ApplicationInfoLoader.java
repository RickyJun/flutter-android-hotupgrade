...
final class ApplicationInfoLoader {
    ...
    static final String PUBLIC_AOT_SHARED_LIBRARY_NAME =
            FlutterLoader.class.getName() + '.' + HotFixFlutterLoader.AOT_SHARED_LIBRARY_NAME;
    static final String PUBLIC_VM_SNAPSHOT_DATA_KEY =
            FlutterLoader.class.getName() + '.' + HotFixFlutterLoader.VM_SNAPSHOT_DATA_KEY;
    static final String PUBLIC_ISOLATE_SNAPSHOT_DATA_KEY =
            FlutterLoader.class.getName() + '.' + HotFixFlutterLoader.ISOLATE_SNAPSHOT_DATA_KEY;
    static final String PUBLIC_FLUTTER_ASSETS_DIR_KEY =
            FlutterLoader.class.getName() + '.' + HotFixFlutterLoader.FLUTTER_ASSETS_DIR_KEY;
