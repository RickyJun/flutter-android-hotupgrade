...
/**
 * copy自FlutterFragmentActivity
 * 修改的地方:在createFlutterFragment()方法里，把FlutterFragment替换成HotFixFlutterFragment
 */
/**
...
public class HotFixFlutterFragmentActivity extends FragmentActivity
    ...
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(HotFixFlutterFragmentActivity.class);
    }
    ...
    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(HotFixFlutterFragmentActivity.class, cachedEngineId);
    }
