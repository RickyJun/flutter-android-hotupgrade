...
/**
 * copy自FlutterActivityAndFragmentDelegate，修改的地方：
 * 把setupFlutterEngine方法里面的，FlutterEngine初始化方法，
 * 由
 *         flutterEngine =
 *                 new FlutterEngine(
 *                         host.getContext(),
...
/* package */ class HotFixFlutterActivityAndFragmentDelegate implements ExclusiveAppComponent<Activity> {
    ...
    HotFixFlutterActivityAndFragmentDelegate(@NonNull Host host) {
        this.host = host;
    }
...
//                        /*willProvideRestorationData=*/ host.shouldRestoreAndSaveState());
    ...
    /* package */ interface Host
         ...
         * FlutterView.RenderMode} is set to {@link
         * FlutterView.RenderMode#surface}. Otherwise, {@link
         ...
         * <p>This method is only invoked if the {@link
         * FlutterView.RenderMode} is set to {@link
         * FlutterView.RenderMode#texture}. Otherwise, {@link
